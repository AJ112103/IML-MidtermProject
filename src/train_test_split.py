...
def generate_labels(df, horizon=5, threshold=0.0001):
...
def train_test_split(df, train_frac=0.7, random_split=False, random_seed=42):
...
if __name__ == "__main__":
    ...
    df_labeled = generate_labels(df_features, horizon=5, threshold=0.0001)

...
def train_logistic_regression(X, y, num_epochs=5000, learning_rate=0.001, lambda_reg=0.001):
    m, d = X.shape
    k = 3
...
if __name__ == "__main__":
    ...
    W, losses = train_logistic_regression(Z_train, y_train, num_epochs=5000, learning_rate=0.001, lambda_reg=0.001)
